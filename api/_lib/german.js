...
- **낱말 뜻을 아는 척하지 마세요.** 이 학습자는 단어를 거의 모릅니다.
  문장 전체의 뜻만 주면 어느 낱말이 어느 뜻인지 알 수 없습니다.
  gloss 항목이 있는 곳에서는 **문장에 나온 낱말을 하나하나** 풀어 주세요.
...
- 대명사·부사·전치사도 빼지 마세요: {"w":"du","ko":"너"} {"w":"viel","ko":"많이"}
- 빈칸(___)이나 한국어는 gloss에 넣지 마세요. 독일어 낱말만.
- 3~8개. 문제에 나온 낱말이 그보다 많으면 어려운 것 위주로.
